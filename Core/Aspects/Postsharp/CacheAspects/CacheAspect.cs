...
namespace Core.Aspects.Postsharp.CacheAspects
{
    ...
    public class CacheAspect:MethodInterceptionAspect
    {
        ...
        //RuntimeInitialize yöntemi çalışma zamanında çağrılır.
        //Bu nedenle, çalışma zamanında başlatma görevlerini gerçekleştirmenin tek yolu RuntimeInitialize'ı geçersiz kılmaktır
